...
- **Train management** - create, edit and delete train records
- **Role-based access** - `GUEST` (read-only), `USER` (create), `ADMIN` (full CRUD)
- **Friendly UX** - station dropdowns for direction and date-time pickers for the schedule
...
The schedule table shows **Train No.**, **Direction** (`from -> to`), **Departure**,
